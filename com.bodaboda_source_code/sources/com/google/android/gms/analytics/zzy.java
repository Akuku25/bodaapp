...
class zzy {
    ...
    public synchronized void zza(zza zza) {
        if (!this.zzCT) {
            this.zzCR.add(zza);
            this.zzCS.append("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(zza.ordinal()));
        }
    }
    ...
    public synchronized String zzfW() {
        ...
        while (this.zzCR.size() > 0) {
            zza zza = (zza) this.zzCR.first();
            this.zzCR.remove(zza);
