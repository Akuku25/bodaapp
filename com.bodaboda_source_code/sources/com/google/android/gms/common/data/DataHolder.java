...
public final class DataHolder implements SafeParcelable {
    ...
    private static CursorWindow[] zza(zza zza, int i) {
        int size;
        int i2 = 0;
        if (zza.zzNU.length == 0) {
            return new CursorWindow[0];
        }
        List zzb = (i < 0 || i >= zza.zzOd.size()) ? zza.zzOd : zza.zzOd.subList(0, i);
        int size2 = zzb.size();
        CursorWindow cursorWindow = new CursorWindow(false);
        ArrayList arrayList = new ArrayList();
        arrayList.add(cursorWindow);
        cursorWindow.setNumColumns(zza.zzNU.length);
        int i3 = 0;
        int i4 = 0;
        while (i3 < size2) {
            ...
            try {
                ...
                boolean z = true;
                for (int i7 = 0; i7 < zza.zzNU.length && z; i7++) {
                    String str = zza.zzNU[i7];
                ...
                if (z) {
                    ...
                    cursorWindow3.setNumColumns(zza.zzNU.length);
