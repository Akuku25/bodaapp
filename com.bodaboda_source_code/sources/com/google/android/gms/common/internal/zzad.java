...
public final class zzad extends Button {
    ...
    private void zzb(Resources resources, int i, int i2) {
        ...
        switch (i) {
            case 0:
            case 1:
                zzb = zzb(i2, C0099R.drawable.common_signin_btn_text_dark, C0099R.drawable.common_signin_btn_text_light);
                break;
            case 2:
                zzb = zzb(i2, C0099R.drawable.common_signin_btn_icon_dark, C0099R.drawable.common_signin_btn_icon_light);
                break;
            default:
    ...
    private void zzc(Resources resources, int i, int i2) {
        setTextColor(resources.getColorStateList(zzb(i2, C0099R.color.common_signin_btn_text_dark, C0099R.color.common_signin_btn_text_light)));
        switch (i) {
            case 0:
