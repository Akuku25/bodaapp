...
class zzbx implements zzat {
    ...
    class zzb extends SQLiteOpenHelper {
        ...
        zzb(zzbx zzbx, Context context, String str) {
            this.zzazt = zzbx;
    ...
    class zza implements com.google.android.gms.tagmanager.zzcw.zza {
        ...
        public void zza(zzap zzap) {
            this.zzazt.zzH(zzap.zzgs());
        }

        public void zzb(zzap zzap) {
            this.zzazt.zzH(zzap.zzgs());
            zzbf.zzab("Permanent failure dispatching hitId: " + zzap.zzgs());
        }

        public void zzc(zzap zzap) {
            long zztj = zzap.zztj();
            if (zztj == 0) {
                this.zzazt.zzd(zzap.zzgs(), this.zzazt.zzmW.currentTimeMillis());
            } else if (zztj + 14400000 < this.zzazt.zzmW.currentTimeMillis()) {
                this.zzazt.zzH(zzap.zzgs());
                zzbf.zzab("Giving up on failed hitId: " + zzap.zzgs());
            }
        }
    }

    zzbx(zzau zzau, Context context) {
        this(zzau, context, "gtm_urls.db", 2000);
    }

    zzbx(zzau zzau, Context context, String str, int i) {
