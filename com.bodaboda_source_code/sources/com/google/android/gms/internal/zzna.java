...
public class zzna extends zzmy<zznk> {
    ...
    public static class zzb implements com.google.android.gms.common.api.Api.zzb<zzna, NoOptions> {
        ...
        public zzna zze(Context context, Looper looper, zzf zzf, NoOptions noOptions, ConnectionCallbacks connectionCallbacks, OnConnectionFailedListener onConnectionFailedListener) {
            return new zzna(context, looper, zzf, connectionCallbacks, onConnectionFailedListener);
        }
    }
    ...
    public zzna(Context context, Looper looper, zzf zzf, ConnectionCallbacks connectionCallbacks, OnConnectionFailedListener onConnectionFailedListener) {
