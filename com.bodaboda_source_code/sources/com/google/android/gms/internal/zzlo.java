...
public class zzlo {
    ...
    private zzlo() {
        ...
        this.zzRx = new zzlr(1024, ((Long) zza.zzRE.get()).longValue());
    }
            ...
            if (zza(context, str, intent, zzb, str2)) {
                ...
                if (!str2.equals("UNBIND")) {
                    if (!str2.equals("DISCONNECT")) {
                        ...
                        zzlm = new zzlm(currentTimeMillis, str2, zzmf.zzR(context), str, zzb2.processName, zzb2.name, zzl, zzb);
                        context.startService(new Intent().setComponent(zzRw).putExtra("com.google.android.gms.common.stats.EXTRA_LOG_EVENT", zzlm));
                    }
                }
                zzlm = new zzlm(currentTimeMillis, str2, null, null, null, null, zzl, zzb);
                context.startService(new Intent().setComponent(zzRw).putExtra("com.google.android.gms.common.stats.EXTRA_LOG_EVENT", zzlm));
            }
        }
    }
