...
public interface zzwg extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzwg {
        ...
        private static class zza implements zzwg {
            ...
            public void zza(Status status, zzvz zzvz, Bundle bundle) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.wallet.internal.IWalletServiceCallbacks");
    ...
    void zza(Status status, zzvz zzvz, Bundle bundle) throws RemoteException;
