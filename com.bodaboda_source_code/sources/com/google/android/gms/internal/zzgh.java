...
public class zzgh implements UncaughtExceptionHandler {
    ...
    public zzgh(Context context, zzhy zzhy, UncaughtExceptionHandler uncaughtExceptionHandler, UncaughtExceptionHandler uncaughtExceptionHandler2) {
    ...
    public static zzgh zza(Context context, Thread thread, zzhy zzhy) {
        if (context == null || thread == null || zzhy == null) {
            return null;
        }
        if (!zzn(context)) {
            return null;
        ...
        UncaughtExceptionHandler zzgh = new zzgh(context, zzhy, uncaughtExceptionHandler, Thread.getDefaultUncaughtExceptionHandler());
        if (uncaughtExceptionHandler != null && (uncaughtExceptionHandler instanceof zzgh)) {
            return (zzgh) uncaughtExceptionHandler;
        }
        try {
            thread.setUncaughtExceptionHandler(zzgh);
            return zzgh;
        } catch (Throwable e) {
