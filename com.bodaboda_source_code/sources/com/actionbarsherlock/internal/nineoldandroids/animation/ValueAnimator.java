...
public class ValueAnimator extends Animator {
    ...
    private static final ThreadLocal<ArrayList<ValueAnimator>> sAnimations = new C00571();
    private static final Interpolator sDefaultInterpolator = new AccelerateDecelerateInterpolator();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sDelayedAnims = new C00593();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sEndingAnims = new C00604();
    private static long sFrameDelay = 10;
    private static final ThreadLocal<ArrayList<ValueAnimator>> sPendingAnimations = new C00582();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sReadyAnims = new C00615();
    ...
    class C00571 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C00571() {
        }
    ...
    class C00582 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C00582() {
        }
    ...
    class C00593 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C00593() {
        }
    ...
    class C00604 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C00604() {
        }
    ...
    class C00615 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C00615() {
        }
