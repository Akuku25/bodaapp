...
public class ListMenuItemView extends LinearLayout implements ItemView {
    ...
    public ListMenuItemView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0055R.styleable.SherlockMenuView, defStyle, 0);
        this.mBackground = a.getDrawable(C0055R.styleable.SherlockMenuView_itemBackground);
        this.mTextAppearance = a.getResourceId(C0055R.styleable.SherlockMenuView_itemTextAppearance, -1);
        this.mPreserveIconSpacing = a.getBoolean(C0055R.styleable.SherlockMenuView_preserveIconSpacing, false);
    ...
    protected void onFinishInflate() {
        ...
        this.mTitleView = (TextView) findViewById(C0055R.id.abs__title);
        if (this.mTextAppearance != -1) {
            this.mTitleView.setTextAppearance(this.mTextAppearanceContext, this.mTextAppearance);
        }
        this.mShortcutView = (TextView) findViewById(C0055R.id.abs__shortcut);
    }
    ...
    private void insertIconView() {
        this.mIconView = (ImageView) getInflater().inflate(C0055R.layout.abs__list_menu_item_icon, this, false);
        addView(this.mIconView, 0);
    }

    private void insertRadioButton() {
        this.mRadioButton = (RadioButton) getInflater().inflate(C0055R.layout.abs__list_menu_item_radio, this, false);
        addView(this.mRadioButton);
    }

    private void insertCheckBox() {
        this.mCheckBox = (CheckBox) getInflater().inflate(C0055R.layout.abs__list_menu_item_checkbox, this, false);
