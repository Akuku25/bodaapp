...
public class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener {
    ...
    private static class SavedState implements Parcelable {
        ...
        class C00621 implements Creator<SavedState> {
            C00621() {
            }
    ...
    private class OverflowMenuButton extends ImageButton implements ActionMenuChildView, View_HasStateListenerSupport {
        ...
        public OverflowMenuButton(Context context) {
            super(context, null, C0055R.attr.actionOverflowButtonStyle);
            setClickable(true);
            setFocusable(true);
            setVisibility(0);
            setEnabled(true);
    ...
    public ActionMenuPresenter(Context context) {
        super(context, C0055R.layout.abs__action_menu_layout, C0055R.layout.abs__action_menu_item_layout);
    }
    ...
    public void initForMenu(Context context, MenuBuilder menu) {
        ...
        if (!this.mMaxItemsSet) {
            this.mMaxItems = ResourcesCompat.getResources_getInteger(context, C0055R.integer.abs__max_action_buttons);
        }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        if (!this.mMaxItemsSet) {
            this.mMaxItems = ResourcesCompat.getResources_getInteger(this.mContext, C0055R.integer.abs__max_action_buttons);
            if (this.mMenu != null) {
