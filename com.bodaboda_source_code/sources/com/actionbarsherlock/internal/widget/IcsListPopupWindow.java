...
public class IcsListPopupWindow {
    ...
    class C00701 implements OnItemSelectedListener {
        C00701() {
        }
    ...
    private static class DropDownListView extends ListView {
        ...
        public DropDownListView(Context context, boolean hijackFocus) {
            super(context, null, C0055R.attr.dropDownListViewStyle);
    ...
    public IcsListPopupWindow(Context context) {
        this(context, null, C0055R.attr.listPopupWindowStyle);
    }
    ...
    public IcsListPopupWindow(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (VERSION.SDK_INT < 11) {
            this.mPopup = new PopupWindowCompat(new ContextThemeWrapper(context, defStyleRes), attrs, defStyleAttr);
        } else {
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mDropDownList.setOnItemSelectedListener(new C00701());
