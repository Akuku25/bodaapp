...
public class IcsSpinner extends IcsAbsSpinner implements OnClickListener {
    ...
    private class DropdownPopup extends IcsListPopupWindow implements SpinnerPopup {
        ...
        class C00721 implements OnItemClickListener {
            C00721() {
            }
        ...
        public DropdownPopup(Context context, AttributeSet attrs, int defStyleRes) {
            ...
            setModal(true);
            setPromptPosition(0);
            setOnItemClickListener(new C00721());
        }
    ...
    public IcsSpinner(Context context, AttributeSet attrs) {
        this(context, attrs, C0055R.attr.actionDropDownStyle);
    }

    public IcsSpinner(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        this.mTempRect = new Rect();
        TypedArray a = context.obtainStyledAttributes(attrs, C0055R.styleable.SherlockSpinner, defStyle, 0);
        DropdownPopup popup = new DropdownPopup(context, attrs, defStyle);
        this.mDropDownWidth = a.getLayoutDimension(C0055R.styleable.SherlockSpinner_android_dropDownWidth, -2);
        popup.setBackgroundDrawable(a.getDrawable(C0055R.styleable.SherlockSpinner_android_popupBackground));
        int verticalOffset = a.getDimensionPixelOffset(C0055R.styleable.SherlockSpinner_android_dropDownVerticalOffset, 0);
        if (verticalOffset != 0) {
            popup.setVerticalOffset(verticalOffset);
        }
        int horizontalOffset = a.getDimensionPixelOffset(C0055R.styleable.SherlockSpinner_android_dropDownHorizontalOffset, 0);
        if (horizontalOffset != 0) {
            popup.setHorizontalOffset(horizontalOffset);
        }
        this.mPopup = popup;
        this.mGravity = a.getInt(C0055R.styleable.SherlockSpinner_android_gravity, 17);
        this.mPopup.setPromptText(a.getString(C0055R.styleable.SherlockSpinner_android_prompt));
