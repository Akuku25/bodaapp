...
public class ActionBarView extends AbsActionBarView {
    ...
    private final OnItemSelectedListener mNavItemSelectedListener = new C02921();
    ...
    public static class HomeView extends FrameLayout {
        ...
        protected void onFinishInflate() {
            this.mUpView = findViewById(C0055R.id.abs__up);
            this.mIconView = (ImageView) findViewById(C0055R.id.abs__home);
        }
    ...
    static class SavedState extends BaseSavedState {
        ...
        class C00681 implements Creator<SavedState> {
            C00681() {
            }
    ...
    class C02921 implements OnItemSelectedListener {
        C02921() {
        }
    ...
    public ActionBarView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0055R.styleable.SherlockActionBar, C0055R.attr.actionBarStyle, 0);
        ApplicationInfo appInfo = context.getApplicationInfo();
        PackageManager pm = context.getPackageManager();
        this.mNavigationMode = a.getInt(C0055R.styleable.SherlockActionBar_navigationMode, 0);
        this.mTitle = a.getText(C0055R.styleable.SherlockActionBar_title);
        this.mSubtitle = a.getText(C0055R.styleable.SherlockActionBar_subtitle);
        this.mLogo = a.getDrawable(C0055R.styleable.SherlockActionBar_logo);
        if (this.mLogo == null) {
            if (VERSION.SDK_INT >= 11) {
                ...
                int resId = ResourcesCompat.loadLogoFromManifest((Activity) context);
                if (resId != 0) {
                    this.mLogo = context.getResources().getDrawable(resId);
                }
            }
        }
        this.mIcon = a.getDrawable(C0055R.styleable.SherlockActionBar_icon);
        if (this.mIcon == null) {
            if (context instanceof Activity) {
                try {
        ...
        int homeResId = a.getResourceId(C0055R.styleable.SherlockActionBar_homeLayout, C0055R.layout.abs__action_bar_home);
        ...
        this.mExpandedHomeLayout.setContentDescription(getResources().getText(C0055R.string.abs__action_bar_up_description));
        this.mTitleStyleRes = a.getResourceId(C0055R.styleable.SherlockActionBar_titleTextStyle, 0);
        this.mSubtitleStyleRes = a.getResourceId(C0055R.styleable.SherlockActionBar_subtitleTextStyle, 0);
        this.mProgressStyle = a.getResourceId(C0055R.styleable.SherlockActionBar_progressBarStyle, 0);
        this.mIndeterminateProgressStyle = a.getResourceId(C0055R.styleable.SherlockActionBar_indeterminateProgressStyle, 0);
        this.mProgressBarPadding = a.getDimensionPixelOffset(C0055R.styleable.SherlockActionBar_progressBarPadding, 0);
        this.mItemPadding = a.getDimensionPixelOffset(C0055R.styleable.SherlockActionBar_itemPadding, 0);
        setDisplayOptions(a.getInt(C0055R.styleable.SherlockActionBar_displayOptions, 0));
        int customNavId = a.getResourceId(C0055R.styleable.SherlockActionBar_customNavigationLayout, 0);
        if (customNavId != 0) {
            this.mCustomNavView = inflater.inflate(customNavId, this, false);
            this.mNavigationMode = 0;
            setDisplayOptions(this.mDisplayOptions | 16);
        }
        this.mContentHeight = a.getLayoutDimension(C0055R.styleable.SherlockActionBar_height, 0);
        a.recycle();
    ...
    public void initProgress() {
        ...
        this.mProgressView.setId(C0055R.id.abs__progress_horizontal);
    ...
    public void initIndeterminateProgress() {
        ...
        this.mIndeterminateProgressView.setId(C0055R.id.abs__progress_circular);
    ...
    public void setMenu(Menu menu, MenuPresenter.Callback cb) {
        if (menu != this.mOptionsMenu) {
            ...
            if (this.mActionMenuPresenter == null) {
                ...
                this.mActionMenuPresenter.setId(C0055R.id.abs__action_menu_presenter);
            ...
            if (this.mSplitActionBar) {
                ...
                this.mActionMenuPresenter.setExpandedActionViewsExclusive(ResourcesCompat.getResources_getBoolean(getContext(), C0055R.bool.abs__action_bar_expanded_action_views_exclusive));
                configPresenters(builder);
                menuView = (ActionMenuView) this.mActionMenuPresenter.getMenuView(this);
                oldParent = (ViewGroup) menuView.getParent();
    ...
    public void setHomeButtonEnabled(boolean enable) {
        ...
        if (!enable) {
            ...
            this.mHomeLayout.setContentDescription(this.mContext.getResources().getText(C0055R.string.abs__action_bar_up_description));
        } else {
            this.mHomeLayout.setContentDescription(this.mContext.getResources().getText(C0055R.string.abs__action_bar_home_description));
        }
    }
            ...
            switch (mode) {
                case 1:
                    if (this.mSpinner == null) {
                        this.mSpinner = new IcsSpinner(this.mContext, null, C0055R.attr.actionDropDownStyle);
                        this.mListNavLayout = (IcsLinearLayout) LayoutInflater.from(this.mContext).inflate(C0055R.layout.abs__action_bar_tab_bar_view, null);
    ...
    private void initTitle() {
        ...
        if (this.mTitleLayout == null) {
            boolean homeAsUp;
            boolean showHome;
            this.mTitleLayout = (LinearLayout) LayoutInflater.from(getContext()).inflate(C0055R.layout.abs__action_bar_title_item, this, false);
            ...
            this.mTitleUpView = this.mTitleLayout.findViewById(C0055R.id.abs__up);
