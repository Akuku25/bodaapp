...
public class ScrollingTabContainerView extends NineHorizontalScrollView implements OnItemSelectedListener {
    ...
    public static class TabView extends LinearLayout {
        ...
        public void update() {
            ...
            if (text != null) {
                if (this.mTextView == null) {
                    CapitalizingTextView textView = new CapitalizingTextView(getContext(), null, C0055R.attr.actionBarTabTextStyle);
    ...
    public ScrollingTabContainerView(Context context) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(null, C0055R.styleable.SherlockActionBar, C0055R.attr.actionBarStyle, 0);
        setContentHeight(a.getLayoutDimension(C0055R.styleable.SherlockActionBar_height, 0));
        a.recycle();
    ...
    private IcsLinearLayout createTabLayout() {
        TabsLinearLayout tabLayout = (TabsLinearLayout) LayoutInflater.from(getContext()).inflate(C0055R.layout.abs__action_bar_tab_bar_view, null);
    ...
    private IcsSpinner createSpinner() {
        IcsSpinner spinner = new IcsSpinner(getContext(), null, C0055R.attr.actionDropDownStyle);
    ...
    private TabView createTabView(Tab tab, boolean forAdapter) {
        TabView tabView = (TabView) this.mInflater.inflate(C0055R.layout.abs__action_bar_tab, null);
